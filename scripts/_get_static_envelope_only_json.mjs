/**
 * scripts/_get_static_envelope_only_json.mjs
 *
 * Brief 28L Gate L3 helper: run the Static envelope-only engine on Bridgewater
 * with current persisted state (post-BRUKL seed) and emit the
 * losses_at_setpoint block as JSON to stdout. Consumed by the Python Gate L3
 * Dynamic comparison script.
 *
...
process.stdout.write(JSON.stringify({
  ...
  losses_at_setpoint: s1.losses_at_setpoint,
  demand: s1.demand,
}, null, 2))
