...
**Current state:** `paused_for_walkthrough` (Brief 28a Part 3, **4 of 6 slices done** — awaiting Chris's walkthrough on 3a-3d before 3e/3f. Brief 28a Part 8 newly scoped in the brief.)
