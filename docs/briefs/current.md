...
**Active:** — none. Brief 38 (Systems Sankey polish) closed `cd448b9`/`8bb143b`/`b96ea42`/`6a8cd69` on 2026-05-19. Next brief queue: (a) a small standalone close-out for the State 2 permanent-vent fix identified in [`docs/audit/39_state2_permanent_vent_diagnosis.md`](../audit/39_state2_permanent_vent_diagnosis.md) (commit `d40f379`); (b) a Systems Library Architecture rewrite (Chris is rewriting the draft offline after the Sankey polish + audit findings).
