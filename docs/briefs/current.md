...
**Active:** [`active/38_systems_sankey_polish.md`](active/38_systems_sankey_polish.md) — Systems Sankey polish. Chat-form authorisation 2026-05-19. Three parts: carrier-block sizing (Part 1 in flight this commit), unserved-demand placeholder, waste-heat flows.
...
| **[`active/38_systems_sankey_polish.md`](active/38_systems_sankey_polish.md)** | **🟡 active** — Part 1 in flight (this commit): carrier-block sizing matches flow stack + prominent MWh labels. Parts 2-3: unserved demand placeholder + waste-heat flows. | (this commit) |
