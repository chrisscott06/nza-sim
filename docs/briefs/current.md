...
**Active:** none. Brief 36 closed in this commit (Parts 1–4 all complete). Internal Gains audited (two new S2 issues in `docs/audit/29_open_issues.md`; no S3 findings); gains palette unified to three shades of purple matching Sankey; shared SchedulePopout chrome live in Internal Gains + Systems modules (Chris's "stuck" complaint resolved; Systems exception-period support deferred to a follow-up brief per Part 3's honest reporting). Awaiting next-brief sequencing — candidates per Brief 36 §close-out: Operation module audit (Brief 37, future) or Dynamic rebuild (Brief 30 resumption).
...
| [`archive/36_internal_gains_audit_polish_COMPLETED.md`](archive/36_internal_gains_audit_polish_COMPLETED.md) | ✅ closed 2026-05-18 — Part 1 Internal Gains Static audit (`2c96896`); Part 2 colour discipline (`376ab41`); Part 3 SchedulePopout shared chrome (`f0b764c`); Part 4 close-out (this commit). Two S2 issues logged (#14 scope contamination, #15 lighting `independent` mode scaling). Systems exception-period support deferred to follow-up brief. | `2c96896`, `376ab41`, `f0b764c`, (this commit) |
