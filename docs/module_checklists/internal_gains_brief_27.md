...
| Pablo chart component port (ChartContainer / ZoomNav / MonthJumpButtons / DataCard / chartTokens.js) | **Brief 28 Part 4** | Investigation report at `docs/pablo_chart_components_investigation.md`. Five clean lifts; the canvas restructure in Brief 28 Part 5 consumes these. |
